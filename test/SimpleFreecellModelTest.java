...
/**
 * Tests for {@link SimpleFreecellModel}.
 */
public class SimpleFreecellModelTest {
  ...
  public void getDeck() {
    ...
    Card aceClubs = new Card(Value.ACE, Suit.CLUBS);
    Card kingSpades = new Card(Value.KING, Suit.SPADES);
    assertEquals(52, deck.size());
    assertEquals(aceClubs, deck.get(0));
    assertEquals(kingSpades, deck.get(deck.size() - 1));
  }
